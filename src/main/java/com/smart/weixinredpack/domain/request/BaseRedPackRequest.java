...
public class BaseRedPackRequest implements Serializable {
    ...
    public String mch_id = WeixinConfig.MCH_ID;   //微信支付分配的商户号  
    public String wxappid = WeixinConfig.WXAPPID;  //公众账号appid
    public String send_name = WeixinConfig.SEND_NAME; //商户名称
